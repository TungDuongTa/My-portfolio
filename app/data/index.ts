...
export const projectData = [
  {
    ...
    description:
      "This project is part of my capstone project with Sample Assist as our client Job Assist is the first job marketplace designed for the healthcare sector, catering to doctors, nurses, and other healthcare professionals. In addition to traditional job marketplaces, Job Assist has integrated a freelancing service to tackle short staffing at critical moments.",
    skills: ["TypeScript", "Next.js", "Nest.js", "Node.js", "AWS"],
  },
  {
    image: "/pc_bg_01.jpg",
    ...
    description:
      "My take on Afk Journey website, a game that I love. This project is Front-end only with animation focused.",
  ...
  },
  {
    ...
    link: "https://ja.digitaltomcat.com.au/",
    description:
      "Ducky is a thrilling 2D precision platformer that follows the adventures of a courageous duck named Ducky as it navigates through challenging levels filled with obstacles and traps",
    skills: ["Unity", "C#"],
  },
